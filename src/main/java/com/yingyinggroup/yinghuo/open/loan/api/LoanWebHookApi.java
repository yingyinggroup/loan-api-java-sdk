...
import com.yingyinggroup.yinghuo.open.loan.request.credit.RepayPlanNotificationDTO;
...
public interface LoanWebHookApi extends LoanApiClient.Api {
    ...
    @Headers("Content-Type: application/json")
    NotificationResponseDTO repayPlanNotification(RepayPlanNotificationDTO repayPlanNoticationDTO);
